...
<body>
    ...
    <div class="box">
        <button class="add btn btn-primary" onclick="window.location.href = '/usuarios/criar'">Adicionar Registro</button>
                ...
                <?php foreach ($users as $user) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-danger" href="/usuarios/deletar/<?= $user['id'] ?>" title="Deletar">
